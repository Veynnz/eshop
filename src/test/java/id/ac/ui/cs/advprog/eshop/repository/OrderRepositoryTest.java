...
class OrderRepositoryTest {
    ...
    void setup() {
        ...
        Order order1 = new Order("13652556-0128-4c07-b546-54eb13960796", products, 1788560000L, "Safira Sudrajat");
        orders.add(order1);

        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-c3ef385fb078", products, 1768570800L, "Safira Sudrajat");
        orders.add(order2);

        Order order3 = new Order("e354ef40-9eff-4da8-9487-8ee697ecbf1e", products, 1768570000L, "Bambang Sudrajat");
        orders.add(order3);
    }
